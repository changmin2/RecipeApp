...
class ClipPaginationProvider<T extends IModelWithId,U extends IBasePaginationRepository<T>> extends StateNotifier<CursorPaginationBase>{
  final U repository;
  String? keyword;
  ClipPaginationProvider({
  ...
  Future<void> paginate({
    ...
    try{
      ...
      final resp = await repository.getClips(
